...
export const CRYPTO_ASSETS: CryptoAsset[] = [
  ...
  { id: 'USDC_BASE', name: 'USD Coin', symbol: 'USDC', network: 'Base', icon: '/crypto-assets/usdc.png', marketSourceId: 'usd-coin', marketPriceUsd: 1, marketRate: 1595, buyRate: 1620.52, sellRate: 1569.48, buySpreadBps: 160, sellSpreadBps: 160, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 0.2 },
  { id: 'USDC_SOLANA', name: 'USD Coin', symbol: 'USDC', network: 'Solana', icon: '/crypto-assets/usdc.png', marketSourceId: 'usd-coin', marketPriceUsd: 1, marketRate: 1595, buyRate: 1620.52, sellRate: 1569.48, buySpreadBps: 160, sellSpreadBps: 160, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 0.2 },
  { id: 'ETH_BASE', name: 'Ethereum', symbol: 'ETH', network: 'Base', icon: '/crypto-assets/eth-base.png', marketSourceId: 'ethereum', marketPriceUsd: 3200, marketRate: 5250000, buyRate: 5391750, sellRate: 5108250, buySpreadBps: 270, sellSpreadBps: 270, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 1.8 },
  { id: 'ETH_ETHEREUM', name: 'Ethereum', symbol: 'ETH', network: 'Ethereum', icon: '/crypto-assets/eth.png', marketSourceId: 'ethereum', marketPriceUsd: 3200, marketRate: 5250000, buyRate: 5418000, sellRate: 5082000, buySpreadBps: 320, sellSpreadBps: 320, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: false, change24h: 1.8 },
  { id: 'SOL_SOLANA', name: 'Solana', symbol: 'SOL', network: 'Solana', icon: '/crypto-assets/sol.png', marketSourceId: 'solana', marketPriceUsd: 180, marketRate: 285000, buyRate: 293550, sellRate: 276450, buySpreadBps: 300, sellSpreadBps: 300, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 2.4 },
  { id: 'BNB_BSC', name: 'BNB', symbol: 'BNB', network: 'BSC', icon: '/crypto-assets/bnb.png', marketSourceId: 'binancecoin', marketPriceUsd: 620, marketRate: 980000, buyRate: 1007440, sellRate: 952560, buySpreadBps: 280, sellSpreadBps: 280, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 1.1 },
  { id: 'POL_POLYGON', name: 'Polygon Ecosystem Token', symbol: 'POL', network: 'Polygon', icon: '/crypto-assets/pol.png', marketSourceId: 'polygon-ecosystem-token', marketPriceUsd: 0.55, marketRate: 880, buyRate: 900, sellRate: 860, buySpreadBps: 300, sellSpreadBps: 300, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: false, change24h: 0.5 },
  { id: 'USDC_POLYGON', name: 'USD Coin', symbol: 'USDC', network: 'Polygon', icon: '/crypto-assets/usdc.png', marketSourceId: 'usd-coin', marketPriceUsd: 1, marketRate: 1595, buyRate: 1620, sellRate: 1570, buySpreadBps: 180, sellSpreadBps: 180, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: false, change24h: 0.1 },
  { id: 'USDT_POLYGON', name: 'Tether USD', symbol: 'USDT', network: 'Polygon', icon: '/crypto-assets/usdt.png', marketSourceId: 'tether', marketPriceUsd: 1, marketRate: 1600, buyRate: 1625, sellRate: 1575, buySpreadBps: 180, sellSpreadBps: 180, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: false, change24h: 0.1 },
  { id: 'TON_TON', name: 'Toncoin', symbol: 'TON', network: 'TON', icon: '/crypto-assets/ton.png', marketSourceId: 'the-open-network', marketPriceUsd: 1.32, marketRate: 1980, buyRate: 2039.4, sellRate: 1920.6, buySpreadBps: 300, sellSpreadBps: 300, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 1.5 },
  { id: 'SUI_SUI', name: 'Sui', symbol: 'SUI', network: 'Sui', icon: '/crypto-assets/sui.png', marketSourceId: 'sui', marketPriceUsd: 1.02, marketRate: 1632, buyRate: 1680.96, sellRate: 1583.04, buySpreadBps: 300, sellSpreadBps: 300, quoteTtlSeconds: 30, isActive: true, baseExecutionEnabled: true, change24h: 1.7 },
