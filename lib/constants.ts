...
export const CRYPTO_ASSETS: CryptoAsset[] = [
  ...
  { id: 'SUI_SUI', name: 'Sui', symbol: 'SUI', network: 'Sui', icon: '/crypto-assets/sui.png', marketSourceId: 'sui', marketPriceUsd: 1.02, marketRate: 1632, buyRate: 1680.96, sellRate: 1583.04, buySpreadBps: 300, sellSpreadBps: 300, quoteTtlSeconds: 30, isActive: true, transakEnabled: false, baseExecutionEnabled: true, change24h: 1.7 },
